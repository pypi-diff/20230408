# Comparing `tmp/calcipy-1.2.2.tar.gz` & `tmp/calcipy-1.2.3.tar.gz`
...
### Comparing `calcipy-1.2.2/calcipy/tasks/all_tasks.py` & `calcipy-1.2.3/calcipy/tasks/all_tasks.py`
